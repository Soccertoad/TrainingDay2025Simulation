...
public class Wrist extends SubsystemBase {
    ...
    private final Gains gains = Robot.isReal() ? WristConstants.TalonFXGains : WristConstants.SimGains;
    ...
    private final LoggedTunableNumber kS =
        new LoggedTunableNumber("Wrist/Gains/kS", gains.kS);
    private final LoggedTunableNumber kV =
        new LoggedTunableNumber("Wrist/Gains/kV", gains.kV);
    private final LoggedTunableNumber kA =
        new LoggedTunableNumber("Wrist/Gains/kA", gains.kA);
    private final LoggedTunableNumber kG =
        new LoggedTunableNumber("Wrist/Gains/kG", gains.kG);
