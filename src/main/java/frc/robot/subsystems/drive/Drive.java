...
public class Drive extends SubsystemBase {
  ...
  public AngularVelocity getFFCharacterizationVelocity() {
    ...
    for (int i = 0; i < 4; i++) {
      output.plus(modules[i].getFFCharacterizationVelocity());
    }
    return output.div(4.0);
  }
  ...
  // private ChassisSpeeds updateDesiredStates(ChassisSpeeds targetChassisSpeeds, SwerveModuleState
  // swerveModuleStates[]) {
  //   Pose2d robot_pose_vel = new Pose2d(targetChassisSpeeds.vxMetersPerSecond *
  // Constants.kSubsystemPeriodSeconds,
  //     targetChassisSpeeds.vyMetersPerSecond * Constants.kSubsystemPeriodSeconds,
  //     Rotation2d.fromRadians(targetChassisSpeeds.omegaRadiansPerSecond *
  // Constants.kSubsystemPeriodSeconds));
  //   Twist2d twist_vel = getPoseLog(robot_pose_vel);
  //   ChassisSpeeds updated_chassis_speeds = new ChassisSpeeds(
  //     twist_vel.dx / Constants.kSubsystemPeriodSeconds, twist_vel.dy /
  // Constants.kSubsystemPeriodSeconds, twist_vel.dtheta / Constants.kSubsystemPeriodSeconds);

  //   SwerveSetpoint currentSetpoint = new SwerveSetpoint(targetChassisSpeeds, swerveModuleStates);

  //   return mSetpointGenerator.generateSetpoint(mKinematicLimits, currentSetpoint,
  // updated_chassis_speeds, Constants.kSubsystemPeriodSeconds).chassisSpeeds;
  // }
