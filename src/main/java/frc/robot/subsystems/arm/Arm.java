...
public class Arm extends SubsystemBase {
  ...
  private final LoggedTunableNumber kS = new LoggedTunableNumber("Arm/Gains/kS", gains.kS);
  private final LoggedTunableNumber kV = new LoggedTunableNumber("Arm/Gains/kV", gains.kV);
  private final LoggedTunableNumber kA = new LoggedTunableNumber("Arm/Gains/kA", gains.kA);
  private final LoggedTunableNumber kG = new LoggedTunableNumber("Arm/Gains/kG", gains.kG);
  ...
  public Command untilGreaterThan(Angle position) {
    return Commands.waitUntil(() -> this.inputs.position.in(Degrees) > position.in(Degrees));
  }

  public Command untilLessThan(Angle position) {
    return Commands.waitUntil(() -> this.inputs.position.in(Degrees) < position.in(Degrees));
  }
}
