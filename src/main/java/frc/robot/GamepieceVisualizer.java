...
public class GamepieceVisualizer extends VirtualSubsystem {
  ...
  private Pose3d getPose() {
    ...
    if (robotPose != null && wristPose != null) {
      return robotPose
          .plus(new Transform3d(wristPose.getTranslation(), wristPose.getRotation()))
          .transformBy(
              new Transform3d(Inches.of(-9), Inches.of(16), Meters.of(0), new Rotation3d()));
    } else {
      return new Pose3d();
    }
  }
